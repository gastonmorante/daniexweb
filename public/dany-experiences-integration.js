...
(function () {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      cat_dolphins_title: "Nado con Delfines",
      cat_dolphins_desc: "Programas especializados de interacción y conexión en distintas locaciones como Dolphin Interax, Primax y The One.",
    ...
    en: {
      ...
      cat_dolphins_title: "Swim with Dolphins",
      cat_dolphins_desc: "Specialized interaction and connection programs in different locations such as Dolphin Interax, Primax, and The One.",
    ...
    fr: {
      ...
      cat_dolphins_title: "Nage avec les Dauphins",
      cat_dolphins_desc: "Programmes d'interaction et de connexion spécialisés dans différents endroits tels que Dolphin Interax, Primax et The One.",
    ...
    it: {
      ...
      cat_dolphins_title: "Nuoto con i Delfini",
      cat_dolphins_desc: "Programmi di interazione e connessione specializzati in diverse località come Dolphin Interax, Primax e The One.",
    ...
    pt: {
      ...
      cat_dolphins_title: "Nado com Golfinhos",
      cat_dolphins_desc: "Programas especializados de interação e conexão em diferentes locais, como Dolphin Interax, Primax e The One.",
