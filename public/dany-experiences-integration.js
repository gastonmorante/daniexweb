...
(function () {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      about_role: "Fundador & Guía",
      about_cred4_title: "Clientes",
      ...
      tours_tag: "Rutas Diseñadas para Ti, guiadas por Dany",
      ...
      bento_title: "Actividades en la Riviera Maya",
      bento_subtitle: "Explora la colección completa de aventuras y excursiones disponibles.",
      cat_eco_parks_title: "Parques Temáticos y Eco-Arqueológicos",
      cat_eco_parks_desc: "Las actividades más populares del sitio, incluyendo toda la familia de parques de Grupo Xcaret y otros parques naturales.",
      cat_archaeology_title: "Zonas Arqueológicas y Cultura",
      cat_archaeology_desc: "Ofrecen visitas guiadas (regulares y privadas) a los principales vestigios mayas: Chichén Itzá, Tulum, Cobá y Ek Balam.",
      cat_sea_title: "Actividades Acuáticas y de Mar",
      cat_sea_desc: "Experiencias de navegación y contacto con la fauna marina: Isla Mujeres, nado con tiburón ballena, Akumal y cruceros.",
      cat_dolphins_title: "Secretos del Arrecife",
      cat_dolphins_desc: "Explora la biodiversidad del Gran Arrecife Maya y el misticismo de las cuevas inundadas. Una inmersión total en las venas de la tierra.",
      cat_adventure_title: "Aventura y Naturaleza",
      cat_adventure_desc: "Combinaciones de adrenalina en la selva: tirolesas en Selvática, motos todoterreno, Xenotes y Las Coloradas.",
    ...
    en: {
      ...
      about_role: "Founder & Guide",
      about_cred4_title: "Clients",
      ...
      tours_tag: "Tours Designed for You, guided by Dany",
      ...
      tour3_book: "Book Now",
      bento_title: "Activities in the Riviera Maya",
      bento_subtitle: "Explore the complete collection of adventures and excursions available.",
      cat_eco_parks_title: "Theme & Eco-Archaeological Parks",
      cat_eco_parks_desc: "The most popular activities on the site, including the entire family of Grupo Xcaret parks and other natural parks.",
      cat_archaeology_title: "Archaeological Zones & Culture",
      cat_archaeology_desc: "Guided tours (regular and private) to the main Mayan ruins: Chichén Itzá, Tulum, Cobá, and Ek Balam.",
      cat_sea_title: "Aquatic & Sea Activities",
      cat_sea_desc: "Sailing experiences and contact with marine fauna: Isla Mujeres, whale shark swimming, Akumal, and cruises.",
      cat_dolphins_title: "Secrets of the Reef",
      cat_dolphins_desc: "Explore the biodiversity of the Great Mayan Reef and the mysticism of flooded caves. A total immersion in the veins of the earth.",
      cat_adventure_title: "Adventure & Nature",
      cat_adventure_desc: "Adrenaline combinations in the jungle: zip lines at Selvática, all-terrain ATVs, Xenotes, and Las Coloradas.",
    ...
    fr: {
      ...
      tours_tag: "Itinéraires Conçus pour Vous, guidés par Dany",
      ...
      tour3_book: "Réserver",
      bento_title: "Activités dans la Riviera Maya",
      bento_subtitle: "Explorez la collection complète d'aventures et d'excursions disponibles.",
      cat_eco_parks_title: "Parcs Thématiques et Éco-Archéologiques",
      cat_eco_parks_desc: "Les activités les plus populaires du site, y compris toute la famille des parcs du Groupe Xcaret et d'autres parcs naturels.",
      cat_archaeology_title: "Zones Archéologiques et Culture",
      cat_archaeology_desc: "Visites guidées (régulières et privées) des principales ruines mayas: Chichén Itzá, Tulum, Cobá et Ek Balam.",
      cat_sea_title: "Activités Aquatiques et de Mer",
      cat_sea_desc: "Expériences de navigation et contact avec la faune marine: Isla Mujeres, nage avec les requins-baleines, Akumal et croisières.",
      cat_dolphins_title: "Secrets du Récif",
      cat_dolphins_desc: "Explorez la biodiversité du Grand Récif Maya et le mysticisme des grottes inondées. Une immersion totale dans les veines de la terre.",
      cat_adventure_title: "Aventure et Nature",
      cat_adventure_desc: "Combinaisons d'adrénaline dans la jungle: tyroliennes à Selvática, quad tout-terrain, Xenotes et Las Coloradas.",
    ...
    it: {
      ...
      about_role: "Fondatore & Guida",
      about_cred4_title: "Clienti",
      ...
      tours_tag: "Percorsi Progettati per Te, guidati da Dany",
      ...
      bento_title: "Attività nella Riviera Maya",
      bento_subtitle: "Esplora la collezione completa di avventure ed escursioni disponibili.",
      cat_eco_parks_title: "Parchi Tematici ed Eco-Archeologici",
      cat_eco_parks_desc: "Le attività più popolari del sito, tra cui l'intera famiglia di parchi del Gruppo Xcaret e altri parchi naturali.",
      cat_archaeology_title: "Zone Archeologiche e Cultura",
      cat_archaeology_desc: "Visite guidate (regolari e private) alle principali rovine maya: Chichén Itzá, Tulum, Cobá ed Ek Balam.",
      cat_sea_title: "Attività Acquatiche e di Mare",
      cat_sea_desc: "Esperienze di navigazione e contatto con la fauna marina: Isla Mujeres, nuoto con gli squali balena, Akumal e crociere.",
      cat_dolphins_title: "Segreti della Barriera",
      cat_dolphins_desc: "Esplora la biodiversità della Grande Barriera Maya e il misticismo delle grotte allagate. Un'immersione totale nelle vene della terra.",
      cat_adventure_title: "Avventura e Natura",
      cat_adventure_desc: "Combinazioni di adrenalina nella giungla: zipline a Selvática, ATV fuoristrada, Xenotes e Las Coloradas.",
    ...
    pt: {
      ...
      tours_tag: "Rotas Projetadas para Você, guiadas por Dany",
      ...
      bento_title: "Atividades na Riviera Maya",
      bento_subtitle: "Explore a coleção completa de aventuras e excursões disponíveis.",
      cat_eco_parks_title: "Parques Temáticos e Eco-Arqueológicos",
      cat_eco_parks_desc: "As atividades mais populares do site, incluindo toda a família de parques do Grupo Xcaret e otros parques naturais.",
      cat_archaeology_title: "Zonas Arqueológicas e Cultura",
      cat_archaeology_desc: "Visitas guiadas (regulares e privadas) às principais ruínas maias: Chichén Itzá, Tulum, Cobá e Ek Balam.",
      cat_sea_title: "Atividades Aquáticas e de Mar",
      cat_sea_desc: "Experiências de navegação e contato com a fauna marina: Isla Mujeres, nado com tubarão-baleia, Akumal e cruzeiros.",
      cat_dolphins_title: "Segredos do Arrecife",
      cat_dolphins_desc: "Explore a biodiversidade do Grande Arrecife Maya e o misticismo das cavernas inundadas. Uma imersão total nas veias da terra.",
      cat_adventure_title: "Aventura e Natureza",
      cat_adventure_desc: "Combinações de adrenalina na selva: tirolesas em Selvática, quadriciclos todo-o-terreno, Xenotes e Las Coloradas.",
